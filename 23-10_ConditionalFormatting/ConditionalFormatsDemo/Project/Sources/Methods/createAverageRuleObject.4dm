//%attributes = {}
// Create Average Rule Object Method
...
// create average rule object
$ruleObj:=New object:C1471
$ruleObj.ruleType:=8  // establishes average rule type
$ruleObj.style:=New object:C1471("backColor"; "#F0948B")
$ruleObj.type:=0  // will format cell if above average value
