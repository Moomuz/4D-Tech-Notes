// Text - Write Text Button Object Method (Write)
// writes the user input to "FoxInSocks_Text.txt" at the write handle offset (does not insert new line character)
...
Case of 
	: (Form event code:C388=On Clicked:K2:4)
		// get user input
		$input:=Form:C1466.text_writeTextInput
		
		// write directly to file
		Form:C1466.text_writeHandle.writeText($input)
