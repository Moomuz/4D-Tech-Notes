...
extern unsigned char D_obj_p_10_TextStyle_00ItalicCheckBox[];
void obj_p_10_TextStyle_00ItalicCheckBox( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_10_TextStyle_00ItalicCheckBox);
	if (!ctx->doingAbort) {
