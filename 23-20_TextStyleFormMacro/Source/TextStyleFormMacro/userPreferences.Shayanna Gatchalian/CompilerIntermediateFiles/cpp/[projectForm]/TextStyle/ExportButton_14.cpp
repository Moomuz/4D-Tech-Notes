...
extern unsigned char D_obj_p_9_TextStyle_00ExportButton[];
void obj_p_9_TextStyle_00ExportButton( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_9_TextStyle_00ExportButton);
	if (!ctx->doingAbort) {
