...
extern unsigned char D_obj_p_11_TextStyle_00UnderlineCheckBox[];
void obj_p_11_TextStyle_00UnderlineCheckBox( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_11_TextStyle_00UnderlineCheckBox);
	if (!ctx->doingAbort) {
