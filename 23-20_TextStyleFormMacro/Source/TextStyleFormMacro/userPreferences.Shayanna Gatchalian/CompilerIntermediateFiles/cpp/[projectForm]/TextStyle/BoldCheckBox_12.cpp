...
extern unsigned char D_obj_p_13_TextStyle_00BoldCheckBox[];
void obj_p_13_TextStyle_00BoldCheckBox( Asm4d_globals *glob, tProcessGlobals *ctx, int32_t inNbExplicitParam, int32_t inNbParam, PCV inParams[], CV *outResult)
{
	CallChain c(ctx,D_obj_p_13_TextStyle_00BoldCheckBox);
	if (!ctx->doingAbort) {
